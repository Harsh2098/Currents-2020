...
body {
	...
	background: url("{{ asset('http://currents.nitt.edu/images/event-or-bg.jpg') }}");
...
<a href="https://www.facebook.com/currentsnitt"><img class="logo left" src="{{asset('http://currents.nitt.edu/images/logo-bw.png')}}"></a>
<div class="wrapper">
	<div class="title">
		<img class="logo" src="{{asset('http://currents.nitt.edu/images/volts_logo-bw.png')}}">
	</div>
</div>
<div class="container">
	<div class="content">
		<a href="{{ env('APP_BASE_URL') }}/volts/coimbatore"><img class="img-link smaller" src="{{asset('http://currents.nitt.edu/images/coimbatore-round.png')}}"></a>
